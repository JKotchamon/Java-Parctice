...
//Ex8.1 Strings
let text1 = "Hello";
let text2 = "My name is Guidehandsome";
let text3 = "Nice to meet you";
...
let x2 = 34;
let x3 = 3.14;
document.getElementById("ex8-2").innerHTML= x1 +"<br>" +x2+"<br>"+x3;
...
document.getElementById("ex8-4").innerHTML= person.firstName + " " +person.lastName+" is " +person.age +" years old. ";
