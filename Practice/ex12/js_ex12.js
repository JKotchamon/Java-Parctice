...
var radius =8;
document.getElementById("ex12-1").innerHTML = "radius = 8 <br> PI = "
+Math.pi +"<br> Circle Area = " + Math.PI * Math.pow(radius,2); //PI*radius*radius
...
//Ex12.4 Math Random Function
function getRandom1(){
    document.getElementById("ex12-4-1").innerHTML = Math.random();
}

function getRandom2(){
    document.getElementById("ex12-4-2").innerHTML = Math.floor((Math.random())*101);
    // 0-100 => total 101 numbers
}

function getRandom3(){
    document.getElementById("ex12-4-3").innerHTML = Math.floor((Math.random())*100)+ 1 ;
    // 1-100 => (0-99)+ 1 => 100 numbers
}
